...
\midrule
\textbf{\LightRet{} (ours)}             & \textbf{$\sim$4M} & \textbf{\todo{XX.X}} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
BERT-base   & 110M & 92.14 & \todo{XX.X} & \todo{XX.X} & \todo{XX.X} \\
CharBERT    & 114M & 92.61 & \todo{XX.X} & \todo{XX.X} & \todo{XX.X} \\
DistilBERT  &  66M & 90.70 & \todo{XX.X} & \todo{XX.X} & \todo{XX.X} \\
\midrule
...
\midrule
\LightRet{} (full, 3-stage)                  & \todo{XX.X} & \todo{XX.X} \\
\quad w/o Stage~1 (skip \RetBERT{})          & \todo{XX.X} & \todo{XX.X} \\
\quad w/o Stage~2 (direct NER finetune)      & \todo{XX.X} & \todo{XX.X} \\
\quad w/o noise augmentation in Stage~3      & \todo{XX.X} & \todo{XX.X} \\
\quad $\calL_3 = \calL_{\text{class}}$ only ($\beta{=}1$) & \todo{XX.X} & \todo{XX.X} \\
\quad $\calL_3 = \calL_{\text{distill}}$ only ($\beta{=}0$) & \todo{XX.X} & \todo{XX.X} \\
\quad Replace \RetVec{} with random char emb. & \todo{XX.X} & \todo{XX.X} \\
\bottomrule
\end{tabular}
}
\end{table}
...
\midrule
BERT-base  & 110M & \todo{X.X} & \todo{XX.X} \\
DistilBERT &  66M & \todo{X.X} & \todo{XX.X} \\
\textbf{\LightRet{}} & \textbf{$\sim$4M} & \textbf{\todo{X.X}} & \textbf{\todo{X.X}} \\
\bottomrule
\end{tabular}
\end{table}
