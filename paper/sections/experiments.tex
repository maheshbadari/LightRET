...
\textbf{Stage~1} provides a modest but consistent gain ($-$1.0 clean, $-$1.6 medium),
showing that the RetBERT intermediate bridge helps transfer richer contextual structure
than distilling BERT directly into LightRet.
