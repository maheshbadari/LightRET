...
The ablation study (Table~\ref{tab:ablation}) evaluates three boundary values
of $\beta$: $\beta{=}0$ (distillation only), $\beta{=}0.5$ (equal weighting),
and $\beta{=}1$ (classification only).
$\beta{=}0$ collapses to near-random F1 (2.5), confirming that NER label
supervision is non-negotiable.
$\beta{=}1$ performs reasonably (84.6 clean, 74.2 medium) but lags behind
$\beta{=}0.5$ (85.7 clean, 78.0 medium), showing that the teacher alignment
signal provides consistent regularisation beyond label supervision alone.
The compound loss at $\beta{=}0.5$ achieves the best balance and is used
